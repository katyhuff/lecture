...
\subsubsection{Peak Heat Based Estimation}

Since, for most nuclides, the decay heat curve lowers over time, one 
conservative estimation could base the heat ba 
